...
public class ProjectileObjectPlace : MonoBehaviour
{
    [Header("General")]
    ...
    [Header("Object Place/Switch")]
    [Tooltip("Game object that will be placed/replaced by this projectile on impact")]
    public GameObject shootElement = null;
    ...
    private void OnEnable()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<ProjectileBase, ProjectileObjectPlace>(m_ProjectileBase, this, gameObject);
    ...
    bool IsHitValid(RaycastHit hit)
    {
        ...
        // ignore hits with triggers that don't have a Switchable or PlaceableOn component
        if (hit.collider.isTrigger
            && hit.collider.GetComponent<Switchable>() == null
            && hit.collider.GetComponent<PlaceableOn>() == null)
        {
            return false;
        }
    ...
    void OnHit(Vector3 point, Vector3 normal, Collider collider)
    {
        ...
        if (placeable)
        {
            placeable.Place(this.shootElement, point, normal);
        }
